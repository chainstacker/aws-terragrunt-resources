locals {
  ...
  module_version = try(
    local.merged_locals.module_terraform_aws_modules_security_groups_version,
...
terraform {
  source = "tfr:///terraform-aws-modules/security-group/aws?version=${local.module_version}"
}
